...
async function handleRequest(req, res) {
  ...
  if (req.url === "/comments.html")
    return makeStream(req, res, DATA.comments, formatComment);
  if (req.url === "/albums.html")
    return makeStream(req, res, DATA.albums, formatAlbum);
  if (req.url === "/todos.html")
    return makeStream(req, res, DATA.todos, formatTodo);
  if (req.url === "/users.html")
    return makeStream(req, res, DATA.users, formatUser);
